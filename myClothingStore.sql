...
('Floral Summer Dress',   'Zara',      'Dresses',    'S',   'Like New',   450.00, 'Light floral dress, perfect for summer.',         'images/Floral Summer Dress.jpg', 5, 'available'),
('Grey Skinny Jeans',     'Woolworths','Bottoms',    '32',  'Good',       280.00, 'Comfortable grey skinny jeans.',                  'images/Grey Skinny Jeans.jpg', 3, 'available'),
('Checked Blazer',        'Markham',   'Jackets',    'L',   'Excellent',  520.00, 'Smart checked blazer for formal occasions.',      'images/Checked Blazer.jpg', 5, 'available'),
('Red Polo Shirt',        'Lacoste',   'Tops',       'M',   'Good',       375.00, 'Classic Lacoste polo, red.',                      'images/Red Polo Shirt.jpg', 3, 'available'),
('Khaki Cargo Shorts',    'Mr Price',  'Bottoms',    '34',  'Good',       120.00, 'Sturdy cargo shorts with side pockets.',          'images/Khaki Cargo Shorts.jpg', 5, 'available'),
('Ankle Boots',           'Steve Madden','Shoes',    '7',   'Like New',   680.00, 'Stylish ankle boots, barely worn.',               'images/Ankle boots.jpg', 3, 'available'),
('Striped T-Shirt',       'Cotton On', 'Tops',       'S',   'Excellent',  89.99,  'Casual striped tee, great condition.',            'images/Striped T-Shirt.jpg', 5, 'available'),
